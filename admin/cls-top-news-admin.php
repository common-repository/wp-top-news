...
class WTN_Admin 
{
	...
	protected $wtn_version, $wtn_assets_prefix;
	...
	*/
	function wtn_enqueue_assets() {
		...
		wp_enqueue_style(
			$this->wtn_assets_prefix . 'fontawesome-iconpicker', 
			WTN_ASSETS .'css/fontawesome-iconpicker.min.css',
			array(),
			$this->wtn_version,
			FALSE
		);
		...
		//if ( wtn_fs()->is_plan__premium_only('pro', true) ) {
			
			wp_enqueue_script(
				'wtn-fontawesome-iconpicker',
				WTN_ASSETS . 'js/fontawesome-iconpicker.min.js',
				array('jquery'),
				$this->wtn_version,
				true
			);
	...
	*/
	function wtn_admin_menu(){
		...
		add_menu_page(  
			__('WP Top News - External', 'wp-top-news'),
			__('WP Top News - External', 'wp-top-news'),
			'manage_options',
			'wtn-ext-admin-settings',
	...
	function wtn_custom_post_type() {
		...
		$labels = array(
							...
							'menu_name'           => __('WP Top News - Internal', 'wp-top-news'),
							...
							'add_new'             => __('Add News', 'wp-top-news'),
	...
	function wtn_register_taxonomy() {
		...
		$labels = array(
			...
			'add_new_item' 		=> __('Add News Category', 'wp-top-news'),
			'new_item_name' 	=> __('News Category Name', 'wp-top-news'),
